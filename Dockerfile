...
ARG CODEX_UID=1000
ARG CODEX_GID=1000
ARG CODEX_WEB_RELEASE_VERSION=dev
ARG CODEX_WEB_GIT_REVISION=unknown
ARG CODEX_WEB_BUILD_SOURCE=https://github.com/garnser/codex-web
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    CODEX_WEB_PORT=8765 \
    CODEX_WEB_RELEASE_VERSION=${CODEX_WEB_RELEASE_VERSION} \
    CODEX_WEB_GIT_REVISION=${CODEX_WEB_GIT_REVISION} \
    CODEX_WEB_BUILD_SOURCE=${CODEX_WEB_BUILD_SOURCE} \
    HOME=/home/codex
