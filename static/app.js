...
const selectProject=installProjectNavigation(state,async()=>{state.threadId=null;state.activeAgentMessage=null;applyRunSettings();await refresh();},error=>addMessage("Error",error.message,"tool",new Date()));
