...
REMOVED = {
    ...
    "_owner_work_watchdog_loop",
    "_release_gate_watchdog_loop",
    "_work_item_sla_watchdog_loop",
    "_orchestrator_watchdog_loop",
    "_split_brain_watchdog_loop",
    "_queue_recovery_loop",
    "startup",
    "shutdown",
}
...
def delete_extracted_definitions() -> int:
    ...
    if missing:
        raise SystemExit(f"Expected RuntimeSupervisor definitions were not found in legacy_core.py: {missing}")
...
if __name__ == "__main__":
    ...
    print(f"legacy_core.py shrunk to {new_size} bytes; removed {len(REMOVED)} lifecycle definitions")
