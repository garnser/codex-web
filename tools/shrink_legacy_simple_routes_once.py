...
def delete_extracted_definitions() -> int:
    ...
    if missing:
        raise SystemExit(f"Expected extracted simple route definitions were not found: {missing}")
...
if __name__ == "__main__":
    ...
    print(f"legacy_core.py shrunk to {new_size} bytes; removed {len(REMOVED)} simple API route definitions")
