...
- [Canonical Agent Teams](agent-teams.md) — bounded deterministic-first Team assignment, leader delegation, exact Profile/Definition provenance, loop protection, budgets, Attention escalation, and Work Item traceability.
