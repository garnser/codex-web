...
- [Runtime health hot paths](runtime-health-hot-paths.md) — cached/coalesced health evaluation, event-loop isolation, stale-cache behavior, and slow-operation observability.
