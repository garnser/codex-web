...
class ExecutionWorkspaceAdminUiTests(unittest.TestCase):
    def test_workspace_inspector_exposes_isolation_lease_and_cleanup_state(self) -> None:
        ...
        self.assertIn("subjectText", javascript)
        self.assertIn("workspace.subject?.kind", javascript)
        self.assertIn("workspace.subject?.ref", javascript)
        self.assertIn("branch_name", javascript)
        self.assertIn("base_revision", javascript)
        self.assertIn("head_revision", javascript)
        self.assertIn("repository_members", javascript)
        self.assertIn("access_mode", javascript)
        self.assertIn("source_path", javascript)
        self.assertIn("workspace_path", javascript)
        self.assertIn("sandbox_path", javascript)
        self.assertIn("member.disk_bytes", javascript)
