...
class CodexAuthDelegationService:
    ...
    def command(*, subcommand: tuple[str, ...] = ("app-server",)) -> tuple[str, ...]:
        ...
        return (
            ...
            "--config",
            'shell_environment_policy.filters.HTTP_PROXY="exclude"',
            "--config",
            'shell_environment_policy.filters.HTTPS_PROXY="exclude"',
            "--config",
            'shell_environment_policy.filters.ALL_PROXY="exclude"',
            "--config",
            'shell_environment_policy.filters.NO_PROXY="exclude"',
            "--config",
            'shell_environment_policy.filters.http_proxy="exclude"',
            "--config",
            'shell_environment_policy.filters.https_proxy="exclude"',
