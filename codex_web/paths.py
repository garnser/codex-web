...
EXTENSION_PACKAGE_DIR = DATA_DIR / "extensions" / "packages"
ARTIFACT_CONTENT_DIR = DATA_DIR / "artifact-content"
...
GITLAB_ROUTING_FILE = DATA_DIR / "gitlab_routing.json"
GITLAB_SEMANTIC_EVENTS_FILE = DATA_DIR / "gitlab_semantic_events.json"
SUPPORT_SERVICEDESK_STATE_FILE = DATA_DIR / "support_servicedesk_intake.json"
AGENT_CHANNEL_PRESENCE_FILE = DATA_DIR / "agent_channel_presence.json"
...
WORK_ITEM_STATES_FILE = DATA_DIR / "work_item_states.json"
WORK_ITEM_EVENTS_FILE = DATA_DIR / "work_item_events.jsonl"
